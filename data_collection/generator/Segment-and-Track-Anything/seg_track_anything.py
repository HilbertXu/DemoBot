...
def tracking_objects_in_video(SegTracker, input_video, input_img_seq, fps, frame_num=0, output_dir=None):
    ...
    if output_dir is None:
        ...
        tracking_result_dir = output_dir
    
    io_args = {
        'tracking_result_dir': tracking_result_dir,
        'output_mask_dir': f'{tracking_result_dir}',
...
def img_seq_type_input_tracking(SegTracker, io_args, video_name, imgs_path, fps, frame_num=0):
    ...
    # save colorized masks as a gif
    imageio.mimsave(io_args['output_gif'], masked_pred_list, duration=1000.0 * (1/fps))
    print("{} saved".format(io_args['output_gif']))
