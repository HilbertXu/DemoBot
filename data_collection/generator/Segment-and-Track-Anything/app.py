...
def tracking_objects(Seg_Tracker, input_video, input_img_seq, fps, output_dir=None, frame_num=0):
    # remove
    ...
    # pdb.set_trace()
    return tracking_objects_in_video(
        SegTracker=Seg_Tracker, 
            ...
            with gr.Column(scale=0.5):
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        output_dir = gr.Textbox(label="Output folder", value="./tracking_results", placeholder="Path to output folder")
