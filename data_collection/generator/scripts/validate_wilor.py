...
def interpolate_hand_pose(data_dir, seq_name, hand_type):
    """
    ...
    data_path = f"{data_dir}/{seq_name}/processed/hold_fit.init.npy"
    data_2d_path = f"{data_dir}/{seq_name}/processed/j2d.full.npy"
    ...
    assert hand_type in ['right', 'left', 'bimanual'], "Please specify the correct hand type"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, help="root of the data folders")
    parser.add_argument("--seq_name", type=str, help="Name of the sequence to process")
    parser.add_argument("--hand_type", type=str, help="right, left, or bimanual")
    args = parser.parse_args()

    interpolate_hand_pose(args.data_dir, args.seq_name, args.hand_type)
