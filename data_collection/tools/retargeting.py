...
def parse_args():
    ...
    parser.add_argument("--camera_f", type=str, help="path to the camera file")
...
class AllegroHandRetargeting(object):
    ...
    def retarget(self, scene_dir, camera_f):
        ...
        hand_shape = np.load('./dataset/hand.npy') # optimized hand shape, has similar finger length to allegro hand
